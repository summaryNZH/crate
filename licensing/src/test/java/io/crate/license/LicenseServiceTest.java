...
public class LicenseServiceTest extends CrateDummyClusterServiceUnitTest {
    ...
    @Test
    public void testIsLicenseExpiringWithinOneDay() {
        DecryptedLicenseData licenseData = new DecryptedLicenseData(
            System.currentTimeMillis() + TimeUnit.HOURS.toMillis(5), "test");
        assertThat(licenseService.isLicenseExpiringWithin(1, DAYS, licenseData), is(true));
    }
